-- Based on CachyOS/cachyos-hypr-noctalia's default etc/skel/.config/hypr/config/binds.lua.
-- Two deliberate deviations from upstream, marked below:
--   1. SUPER+Space -> Vicinae (was Noctalia's own launcher panel)
--   2. SUPER+T -> terminal (was EDITOR; SUPER+Return already opens TERMINAL too,
--      kept as a second muscle-memory key rather than replacing it)
-- Everything else is upstream CachyOS default, unchanged.
...
hl.bind(mainMod .. " + T",          hl.dsp.exec_cmd(launchPrefix .. TERMINAL)) -- was EDITOR upstream
...
hl.bind(mainMod .. " + Space",      hl.dsp.exec_cmd("vicinae toggle")) -- was noctalia msg panel-toggle launcher upstream
...
-- Screen Capture (Noctalia's quick capture kept as-is; Spectacle added separately
-- for screen recording, which Noctalia's screenshot command doesn't do)
hl.bind(mainMod .. " + P",         hl.dsp.exec_cmd("hyprpicker -a -n"))
hl.bind("Print",                   hl.dsp.exec_cmd(noctCall .. "screenshot-region"))
hl.bind(mainMod .. " + Print",     hl.dsp.exec_cmd(noctCall .. "screenshot-fullscreen"))
hl.bind(mainMod .. " + SHIFT + Print", hl.dsp.exec_cmd(launchPrefix .. "spectacle")) -- full picker + screen recorder
